...
.back-nav-btn:hover { background: rgba(4, 120, 87, 0.06); }
...
.r-btn.primary:hover { background: rgba(4, 120, 87, 0.06); }
.r-btn.secondary { background: var(--sn-surface); color: var(--sn-primary); border-color: var(--sn-primary); }
.r-btn.secondary:hover { background: rgba(4, 120, 87, 0.06); }
...
:deep(.send-button:hover) { background: rgba(4, 120, 87, 0.06) !important; }
...
.modern-confirm-dialog .el-button--primary { background: var(--sn-primary) !important; color: var(--sn-surface) !important; box-shadow: 0 4px 12px rgba(4, 120, 87,0.15) !important; }
